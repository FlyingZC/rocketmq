...
public class NamesrvConfig {
    ...
    private String kvConfigPath = System.getProperty("user.home") + File.separator + "namesrv" + File.separator + "kvConfig.json";// NameServer存储 KV 配置属性的持久化路径
    private String configStorePath = System.getProperty("user.home") + File.separator + "namesrv" + File.separator + "namesrv.properties";// nameServer配置文件路径
    private String productEnvName = "center";
    private boolean clusterTest = false;
    private boolean orderMessageEnable = false;// 是否支持顺序消息，默认是不支持
